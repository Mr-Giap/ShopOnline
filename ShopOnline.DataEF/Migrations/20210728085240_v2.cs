        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricPromotion = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bills_AppUser_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SrcButton = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    slideId = table.Column<int>(type: "int", nullable: true),
                    imageId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageSlides", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImagesProduct_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdColorProduct = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ColorSizes_ColorProducts_colorProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ColorSizes_colorProductId",
                table: "ColorSizes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageSlides_slideId",
                table: "ImageSlides",
                column: "slideId");

            migrationBuilder.CreateIndex(
                name: "IX_ImagesProduct_ImageId",
                table: "ImagesProduct",
                column: "ImageId");
